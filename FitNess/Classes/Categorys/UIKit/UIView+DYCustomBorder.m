...
@implementation UIView (DYCustomBorder)
...
- (void)dy_addTopBorderWithColor:(UIColor *)color width:(CGFloat)borderWidth {
    [self dy_addTopBorderWithColor:color width:borderWidth excludePoint:0 edgeType:0];
}


- (void)dy_addLeftBorderWithColor:(UIColor *)color width:(CGFloat)borderWidth {
    [self dy_addLeftBorderWithColor:color width:borderWidth excludePoint:0 edgeType:0];
}


- (void)dy_addBottomBorderWithColor:(UIColor *)color width:(CGFloat) borderWidth {
    [self dy_addBottomBorderWithColor:color width:borderWidth excludePoint:0 edgeType:0];
}


- (void)dy_addRightBorderWithColor:(UIColor *)color width:(CGFloat)borderWidth {
    [self dy_addRightBorderWithColor:color width:borderWidth excludePoint:0 edgeType:0];
}
...
- (void)dy_addTopBorderWithColor:(UIColor *)color width:(CGFloat)borderWidth excludePoint:(CGFloat)point edgeType:(DYExcludePoint)edge {
    ...
    if (edge & DYExcludeStartPoint) {
        startPoint += point;
    }
    
    if (edge & DYExcludeEndPoint) {
        endPoint += point;
    }
