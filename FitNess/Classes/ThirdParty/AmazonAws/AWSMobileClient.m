...
- (BOOL)didFinishLaunching:(UIApplication *)application
    ...
    [[AWSSignInManager sharedInstance] registerAWSSignInProvider:[AWSCognitoUserPoolsSignInProvider sharedInstance]];
    [[AWSIdentityProfileManager sharedInstance] registerIdentityProfile:[CognitoUserPoolsIdentityProfile sharedInstance]
